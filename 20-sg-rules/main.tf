...
# redis allowing connections from bastion on port 6379
...
# redis allowing connections from shipping on port 6379
...
# mysql allowing connections from bastion on port 6379
...
# rabbitmq allowing connections from payment on port 6379
...
# backend_alb, http based request
